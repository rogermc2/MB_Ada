...
package FF_Parameters is
   ...
   BPB_RsvdSecCnt : constant Long_Integer := 14;  --  Size of reserved area [sector] (WORD)
   BPB_NumFATs    : constant Long_Integer := 16;  --  Number of FATs (BYTE)
   BPB_RootEntCnt : constant Long_Integer := 17;  --  Size of root directory area for FAT12/16 [entry] (WORD)
   BPB_TotSec16   : constant Long_Integer := 19;  --  Volume size (16-bit) [sector] (WORD)
   BPB_Media      : constant Integer := 21;  --  Media descriptor byte (BYTE)
   BPB_FATSz16    : constant Long_Integer := 22;  --  FAT size (16-bit) [sector] (WORD)
   ...
   BPB_TotSec32   : constant Long_Integer := 32;  --  Volume size (32-bit) [sector] (DWORD)
   --  FAT12 and FAT 16
   ...
   BPB_Reserved   : constant Integer := 52;  --  FAT32:  Reserved for future expansion.
                                             --          All of the bytes of this field should be 0.
   ...
   FSI_Reserved1  : constant Integer := 4;    --  FAT32:  Reserved for future expansion.
                                              --          All of the bytes of this field should be 0.
   ...
   FSI_Reserved2  : constant Integer := 496;  --  FAT32:  Reserved for future expansion.
                                              --          All of the bytes of this field should be 0
   FSI_TrailSig   : constant Integer := 508;  --  Value 0xAA550000.
                                              --  This trail signature is used to validate that this is an FSInfo sector.
   --  End of FAT32 Structure
